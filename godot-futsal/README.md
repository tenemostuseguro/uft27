...
- Sistemas funcionales:
  - sobres
  - mercado de jugadores (compra/venta) dentro del menú UFT
...
- Nueva página `market_admin.php` enfocada en administración del mercado (`uft_market_catalog`) con altas, edición y eliminación de publicaciones.
...
- La elección de escudo se realiza en una pantalla dedicada (`ClubCrestMenu2D`) con navegación horizontal por flechas y layout tipo tarjeta (país arriba, club al centro, liga/logo abajo).

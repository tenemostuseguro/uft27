...
@onready var loading_status_label: Label = $LoadingLayer/LoadingPanel/LoadingVBox/LoadingStatus
@onready var progress_bar: ProgressBar = $LoadingLayer/LoadingPanel/LoadingVBox/ProgressBar
